...
namespace Ronny.BowlingKata.tests
{
    ...
    public class ScoreCalculatorShould
    {
        ...
        {
            var line = new Line("--------------------");
            AreEqual(0, new ScoreCalculator(line).CalculateScore());
        }
        ...
        {
            var line = new Line("-5------------------");
            AreEqual(5, new ScoreCalculator(line).CalculateScore());
        }
        ...
        public void returns_fifteen_when_only_fifteen_pins_are_knocked_down_without_spare_or_strike()
        {
            ...
            AreEqual(15, new ScoreCalculator(line).CalculateScore());
        }
        ...
        {
            var line = new Line("3/------------------");
            AreEqual(10, new ScoreCalculator(line).CalculateScore());
        }
        ...
        public void returns_eighteen_when_player_knock_down_four_pins_after_a_spare()
        {
            ...
            AreEqual(18, new ScoreCalculator(line).CalculateScore());
        }
    }
}